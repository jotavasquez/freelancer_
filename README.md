...
- header: contiene el menú superior, ajsutado con la propiedad flex que ajusta en forma instantanea los elementos hijos.
- section: intro: imagen de fondo y titulos.
- section: Portfolio: insertado titulo y galeria de imagenes en divs.
- section: About: texto en columnas con propiedad column
- section: Contact: insertado formulario y text area para el campo message.
- section: Footer: iconos con propiedad button.

La mayoría de los valores están en porcentaje para ajustarlo a los tamaños del navegador
